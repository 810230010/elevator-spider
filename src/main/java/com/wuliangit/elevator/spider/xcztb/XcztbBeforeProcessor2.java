 ...
 * @author boom
 * @description 新昌采购
 * @create 2017-06-19 15:24
 **/
public class XcztbBeforeProcessor2 implements PageProcessor {
    ...
    public static Request[] getRequest() {
        ...
        for (int i = 1; i <= 1; i++) {
            ...
            Request request = new Request("http://www.xcztb.gov.cn/TPFront/jyxx/001002/001002002/?Paging="+i);
            //设置get请求
