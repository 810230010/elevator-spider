 ...
 * @author boom
 * @description 新昌中标
 * @create 2017-06-19 14:53
 **/
public class XcztbAfterProcessor1 implements PageProcessor {
    ...
    public static Request[] getRequest() {
        ...
        for (int i = 1; i <= 1; i++) {
            ...
            Request request = new Request("http://www.xcztb.gov.cn/TPFront/jyxx/001001/001001003/?Paging="+i);
            //设置get请求
