...
/**
 * @author boom
 * @description 诸暨市公共资源交易网采购
 * @create 2017-06-22 10:16
 **/
public class ZjztbBeforeProcessor2 implements PageProcessor {
...
//            bid.setPublicTime(html.xpath("/html/body/div[4]/div/div[2]/div[2]/text()").toString().substring(7,15));
    ...
    public static Request[] getRequest() {
        ...
        for (int i = 1; i <= 38; i++) {
            ...
            Request request = new Request("http://www.zjztb.gov.cn/TPFront/zfcg/020003/?Paging="+i);
            //设置get请求
