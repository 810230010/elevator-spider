...
/**
 * @author boom
 * @description 绍兴市柯桥区采购成功
 * @create 2017-06-22 15:52
 **/
public class SxxztbAfterProcessor2 implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        if (page.getUrl().regex("http://www.sxxztb.gov.cn/Bulletin/info.aspx?.*").match()) {
            ...
            bid.setContent(html.xpath("//*[@id=\"Zoom\"]/table/tbody").toString());
            bid.setTitle(title);
    ...
    public static  Request[] getRequest() {
        ...
        for (int i = 1; i <= 64; i++) {
            ...
            Request request = new Request("http://www.sxxztb.gov.cn/Bulletin/viewmore1.aspx?BulletinTypeId=22&frontid=2&pageindex="+i);
            //设置get请求
