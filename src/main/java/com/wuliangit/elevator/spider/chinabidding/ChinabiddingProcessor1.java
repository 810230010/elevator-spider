...
public class ChinabiddingProcessor1 implements PageProcessor {

    // 抓取网站的相关配置，包括：编码、抓取间隔、重试次数等
    private Site site = Site.me().setRetryTimes(3).setSleepTime(2500);
    ...
    public void process(Page page) {
        ...
        if (page.getUrl().regex("http://www.chinabidding.com/bidDetail/.*").match()) {
            ...
            bid.setContent(html.xpath("/html/body/div[2]").toString());
