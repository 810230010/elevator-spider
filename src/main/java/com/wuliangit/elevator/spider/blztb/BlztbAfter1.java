 ...
 */
public class BlztbAfter1 implements PageProcessor {
    ...
    public static Request getRequest() {
            Request request = new Request("http://www.blztb.gov.cn/ssjg.aspx?slt=1&cls=81&pct=10&ord=m&by=1&key=%b5%e7%cc%dd");
            //设置get请求
