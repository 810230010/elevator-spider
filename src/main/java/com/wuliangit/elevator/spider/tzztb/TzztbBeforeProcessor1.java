 ...
 **/
public class TzztbBeforeProcessor1 implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        if(page.getUrl().regex("http://www.tzztb.com/tzcms/gcjyzhaobgg/index_.*").match()){
            Selectable selectable = html.xpath("/html/body/div[2]/div[3]/div/div/div[2]/div[2]");
            Selectable links = selectable.links();
            page.addTargetRequests(selectable.links().regex("http://www.tzztb.com/tzcms/gcjyzhaobgg.*").all());
        }else{
    ...
    public static Request[] getRequest() {
        ...
        for (int i = 1; i <= 396; i++) {
            ...
            String url = "http://www.tzztb.com/tzcms/gcjyzhaobgg/index_" + i + ".htm";
