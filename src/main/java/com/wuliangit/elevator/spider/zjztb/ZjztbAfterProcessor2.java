...
/**
 * @author boom
 * @description 诸暨市公共资源交易网采购成功
 * @create 2017-06-22 10:21
 **/
public class ZjztbAfterProcessor2 implements PageProcessor {
    ...
    public static Request[] getRequest() {
        ...
        for (int i = 1; i <= 24; i++) {
            ...
            Request request = new Request("http://www.zjztb.gov.cn/TPFront/zfcg/020004/?Paging="+i);
            //设置get请求
