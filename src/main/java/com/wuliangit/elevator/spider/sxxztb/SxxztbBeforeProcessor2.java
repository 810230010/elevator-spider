 ...
 **/
public class SxxztbBeforeProcessor2 implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        if (page.getUrl().regex("http://www.sxxztb.gov.cn/Bulletin/info.aspx?.*").match()) {
            ...
            bid.setContent(html.xpath("//*[@id=\"Zoom\"]/table").toString());
            bid.setTitle(title);
    ...
    public static  Request[] getRequest() {
        ...
        for (int i = 1; i <= 75; i++) {
            ...
            Request request = new Request("http://www.sxxztb.gov.cn/Bulletin/viewmore1.aspx?BulletinTypeId=21&frontid=2&pageindex="+i);
            //设置get请求
